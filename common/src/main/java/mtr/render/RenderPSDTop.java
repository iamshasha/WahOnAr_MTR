...
public class RenderPSDTop extends RenderRouteBase<BlockPSDTop.TileEntityPSDTop> {
	...
	private static final ResourceLocation PSD_TOP_TEXTURE = new ResourceLocation("mtr:textures/block/psd_top.png");
	...
	protected void renderAdditionalUnmodified(StoredMatrixTransformations storedMatrixTransformations, BlockState state, Direction facing, int light) {
		...
		RenderTrains.scheduleRender(PSD_TOP_TEXTURE, false, RenderTrains.QueuedRenderLayer.EXTERIOR, (matrices, vertexConsumer) -> {
