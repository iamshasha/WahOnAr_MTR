...
public interface Blocks {
	...
	RegistryObject<Block> CEILING = new RegistryObject<>(() -> new BlockCeilingAuto(BlockProperties.metal(BlockColor.QUARTZ).requiresCorrectToolForDrops().strength(2).lightLevel(state -> 15)));
	RegistryObject<Block> CEILING_LIGHT = new RegistryObject<>(() -> new BlockCeiling(BlockProperties.metal(BlockColor.QUARTZ).requiresCorrectToolForDrops().strength(2).lightLevel(state -> 15)));
	RegistryObject<Block> CEILING_NO_LIGHT = new RegistryObject<>(() -> new BlockCeiling(BlockProperties.metal(BlockColor.QUARTZ).requiresCorrectToolForDrops().strength(2)));
	RegistryObject<Block> CLOCK = new RegistryObject<>(() -> new BlockClock(BlockProperties.metal(BlockColor.QUARTZ).requiresCorrectToolForDrops().strength(2).lightLevel(state -> 5)));
	RegistryObject<Block> CLOCK_POLE = new RegistryObject<>(() -> new BlockClockPole(BlockProperties.metal().requiresCorrectToolForDrops().strength(1)));
	...
	RegistryObject<Block> LOGO = new RegistryObject<>(() -> new Block(BlockProperties.metal(BlockColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(2).lightLevel(state -> 10)));
	...
	RegistryObject<Block> MARBLE_BLUE = new RegistryObject<>(() -> new Block(BlockProperties.stone(BlockColor.TERRACOTTA_LIGHT_BLUE).requiresCorrectToolForDrops().strength(1)));
	RegistryObject<Block> MARBLE_BLUE_SLAB = new RegistryObject<>(() -> new SlabBlock(BlockProperties.stone(BlockColor.TERRACOTTA_LIGHT_BLUE).requiresCorrectToolForDrops().strength(1)));
	RegistryObject<Block> MARBLE_SANDY = new RegistryObject<>(() -> new Block(BlockProperties.stone(BlockColor.TERRACOTTA_YELLOW).requiresCorrectToolForDrops().strength(1)));
	RegistryObject<Block> MARBLE_SANDY_SLAB = new RegistryObject<>(() -> new SlabBlock(BlockProperties.stone(BlockColor.TERRACOTTA_YELLOW).requiresCorrectToolForDrops().strength(1)));
	RegistryObject<Block> METAL = new RegistryObject<>(() -> new Block(BlockProperties.metal(BlockColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(2)));
	RegistryObject<Block> METAL_SLAB = new RegistryObject<>(() -> new SlabBlock(BlockProperties.metal(BlockColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(2)));
	...
	RegistryObject<Block> PIDS_POLE = new RegistryObject<>(() -> new BlockPIDSPole(BlockProperties.metal().requiresCorrectToolForDrops().strength(1)));
	RegistryObject<Block> PLATFORM = new RegistryObject<>(() -> new BlockPlatform(BlockProperties.metal(BlockColor.COLOR_YELLOW).requiresCorrectToolForDrops().strength(2), false));
	RegistryObject<Block> PLATFORM_INDENTED = new RegistryObject<>(() -> new BlockPlatform(BlockProperties.metal(BlockColor.COLOR_YELLOW).requiresCorrectToolForDrops().strength(2).noOcclusion(), true));
	RegistryObject<Block> PLATFORM_NA_1 = new RegistryObject<>(() -> new BlockPlatform(BlockProperties.metal(BlockColor.COLOR_YELLOW).requiresCorrectToolForDrops().strength(2), false));
	RegistryObject<Block> PLATFORM_NA_1_INDENTED = new RegistryObject<>(() -> new BlockPlatform(BlockProperties.metal(BlockColor.COLOR_YELLOW).requiresCorrectToolForDrops().strength(2).noOcclusion(), true));
	RegistryObject<Block> PLATFORM_NA_2 = new RegistryObject<>(() -> new BlockPlatform(BlockProperties.metal(BlockColor.COLOR_YELLOW).requiresCorrectToolForDrops().strength(2), false));
	RegistryObject<Block> PLATFORM_NA_2_INDENTED = new RegistryObject<>(() -> new BlockPlatform(BlockProperties.metal(BlockColor.COLOR_YELLOW).requiresCorrectToolForDrops().strength(2).noOcclusion(), true));
	RegistryObject<Block> PLATFORM_UK_1 = new RegistryObject<>(() -> new BlockPlatform(BlockProperties.metal(BlockColor.COLOR_YELLOW).requiresCorrectToolForDrops().strength(2), false));
	RegistryObject<Block> PLATFORM_UK_1_INDENTED = new RegistryObject<>(() -> new BlockPlatform(BlockProperties.metal(BlockColor.COLOR_YELLOW).requiresCorrectToolForDrops().strength(2).noOcclusion(), true));
	...
	RegistryObject<Block> RAILWAY_SIGN_POLE = new RegistryObject<>(() -> new BlockRailwaySignPole(BlockProperties.metal().requiresCorrectToolForDrops().strength(1).noOcclusion()));
	...
	RegistryObject<Block> RUBBISH_BIN_1 = new RegistryObject<>(() -> new BlockRubbishBin(BlockProperties.metal(BlockColor.COLOR_GRAY).strength(4)));
	RegistryObject<Block> SIGNAL_LIGHT_2_ASPECT_1 = new RegistryObject<>(() -> new BlockSignalLight2Aspect1(BlockProperties.metal(BlockColor.COLOR_BLACK).strength(4)));
	RegistryObject<Block> SIGNAL_LIGHT_2_ASPECT_2 = new RegistryObject<>(() -> new BlockSignalLight2Aspect2(BlockProperties.metal(BlockColor.COLOR_BLACK).strength(4)));
	RegistryObject<Block> SIGNAL_LIGHT_2_ASPECT_3 = new RegistryObject<>(() -> new BlockSignalLight2Aspect3(BlockProperties.metal(BlockColor.COLOR_BLACK).strength(4)));
	RegistryObject<Block> SIGNAL_LIGHT_2_ASPECT_4 = new RegistryObject<>(() -> new BlockSignalLight2Aspect4(BlockProperties.metal(BlockColor.COLOR_BLACK).strength(4)));
	RegistryObject<Block> SIGNAL_LIGHT_3_ASPECT_1 = new RegistryObject<>(() -> new BlockSignalLight3Aspect1(BlockProperties.metal(BlockColor.COLOR_BLACK).strength(4)));
	RegistryObject<Block> SIGNAL_LIGHT_3_ASPECT_2 = new RegistryObject<>(() -> new BlockSignalLight3Aspect2(BlockProperties.metal(BlockColor.COLOR_BLACK).strength(4)));
	RegistryObject<Block> SIGNAL_LIGHT_4_ASPECT_1 = new RegistryObject<>(() -> new BlockSignalLight4Aspect1(BlockProperties.metal(BlockColor.COLOR_BLACK).strength(4)));
	RegistryObject<Block> SIGNAL_LIGHT_4_ASPECT_2 = new RegistryObject<>(() -> new BlockSignalLight4Aspect2(BlockProperties.metal(BlockColor.COLOR_BLACK).strength(4)));
	RegistryObject<Block> SIGNAL_SEMAPHORE_1 = new RegistryObject<>(() -> new BlockSignalSemaphore1(BlockProperties.metal(BlockColor.COLOR_BLACK).strength(4)));
	RegistryObject<Block> SIGNAL_SEMAPHORE_2 = new RegistryObject<>(() -> new BlockSignalSemaphore2(BlockProperties.metal(BlockColor.COLOR_BLACK).strength(4)));
	RegistryObject<Block> SIGNAL_POLE = new RegistryObject<>(() -> new BlockStationColorPole(BlockProperties.metal(BlockColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(2).noOcclusion(), false));
	...
	RegistryObject<Block> STATION_COLOR_METAL = new RegistryObject<>(() -> new BlockStationColor(BlockProperties.metal(BlockColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(2).lightLevel(state -> 10)));
	...
	RegistryObject<Block> STATION_COLOR_POLE = new RegistryObject<>(() -> new BlockStationColorPole(BlockProperties.stone(BlockColor.STONE).requiresCorrectToolForDrops().strength(2).noOcclusion(), true));
	...
	RegistryObject<Block> STATION_COLOR_METAL_SLAB = new RegistryObject<>(() -> new BlockStationColorSlab(BlockProperties.metal(BlockColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(2).lightLevel(state -> 10)));
	...
	RegistryObject<Block> STATION_NAME_ENTRANCE = new RegistryObject<>(() -> new BlockStationNameEntrance(BlockProperties.metal(BlockColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(2).noOcclusion()));
	...
	RegistryObject<Block> STATION_NAME_WALL_WHITE = new RegistryObject<>(() -> new BlockStationNameWallWhite(BlockProperties.metal(BlockColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(2).noOcclusion()));
	RegistryObject<Block> STATION_NAME_WALL_GRAY = new RegistryObject<>(() -> new BlockStationNameWallGray(BlockProperties.metal(BlockColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(2).noOcclusion()));
	RegistryObject<Block> STATION_NAME_WALL_BLACK = new RegistryObject<>(() -> new BlockStationNameWallBlack(BlockProperties.metal(BlockColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(2).noOcclusion()));
	RegistryObject<Block> TACTILE_MAP = new RegistryObject<>(() -> new BlockTactileMap(BlockProperties.metal(BlockColor.QUARTZ).requiresCorrectToolForDrops().strength(2).noOcclusion()));
	...
	RegistryObject<Block> TICKET_MACHINE = new RegistryObject<>(() -> new BlockTicketMachine(BlockProperties.metal(BlockColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(2).lightLevel(state -> 5).noOcclusion()));
