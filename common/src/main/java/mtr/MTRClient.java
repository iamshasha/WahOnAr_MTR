...
public class MTRClient implements IPacket {
	...
	public static void init() {
		...
		RegistryClient.registerPlayerJoinEvent(player -> {
			...
			try {
				// MTR-ANTE rolls the cars itself in JonModelTrainRendererMixin, so MTR's own sway stands down rather than doubling it
	...
	public static void initItemModelPredicate() {
		if (!Keys.LIFTS_ONLY) {
			...
			RegistryClient.registerItemModelPredicate(MTR.MOD_ID + ":selected", Items.RAIL_CONNECTOR_450.get(), ItemBlockClickingBase.TAG_POS);
			RegistryClient.registerItemModelPredicate(MTR.MOD_ID + ":selected", Items.RAIL_CONNECTOR_450_ONE_WAY.get(), ItemBlockClickingBase.TAG_POS);
			RegistryClient.registerItemModelPredicate(MTR.MOD_ID + ":selected", Items.RAIL_CONNECTOR_500.get(), ItemBlockClickingBase.TAG_POS);
			RegistryClient.registerItemModelPredicate(MTR.MOD_ID + ":selected", Items.RAIL_CONNECTOR_500_ONE_WAY.get(), ItemBlockClickingBase.TAG_POS);
			RegistryClient.registerItemModelPredicate(MTR.MOD_ID + ":selected", Items.RAIL_CONNECTOR_600.get(), ItemBlockClickingBase.TAG_POS);
			RegistryClient.registerItemModelPredicate(MTR.MOD_ID + ":selected", Items.RAIL_CONNECTOR_600_ONE_WAY.get(), ItemBlockClickingBase.TAG_POS);
			RegistryClient.registerItemModelPredicate(MTR.MOD_ID + ":selected", Items.RAIL_CONNECTOR_700.get(), ItemBlockClickingBase.TAG_POS);
			RegistryClient.registerItemModelPredicate(MTR.MOD_ID + ":selected", Items.RAIL_CONNECTOR_700_ONE_WAY.get(), ItemBlockClickingBase.TAG_POS);
			RegistryClient.registerItemModelPredicate(MTR.MOD_ID + ":selected", Items.RAIL_CONNECTOR_800.get(), ItemBlockClickingBase.TAG_POS);
			RegistryClient.registerItemModelPredicate(MTR.MOD_ID + ":selected", Items.RAIL_CONNECTOR_800_ONE_WAY.get(), ItemBlockClickingBase.TAG_POS);
