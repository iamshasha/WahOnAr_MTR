...
public interface IGui {
	...
	static boolean isCjkCodePoint(int codePoint) {
		// Every block tested below starts at U+1100 (Hangul Jamo), and every ideographic code point is higher
		// still, so anything lower can skip UnicodeBlock.of - a binary search that this method ran per character.
		if (codePoint < 0x1100) {
			return false;
		}
